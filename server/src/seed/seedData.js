...
export const seedDatabase = async () => {
  try {
    ...
    const workflowDefinitions = [
      ...
      {
        name: 'Scholarship Application & Financial Assistance',
        key: 'scholarship_request',
        description: 'State and university scholarship verification and document approval.',
        category: 'SCHOLARSHIP',
        responsibleDepartmentCode: 'ACCOUNTS',
        requiredFields: ['purpose'],
        steps: [
          { stepKey: 'SUBMITTED', label: 'Application Submitted', roleRequired: 'STUDENT', isApprovalStep: false },
          { stepKey: 'VALIDATION', label: 'Document & Eligibility Triage', roleRequired: 'SYSTEM', isApprovalStep: false },
          { stepKey: 'ACCOUNTS_REVIEW', label: 'Accounts Desk Verification', roleRequired: 'STAFF', assignedDepartmentCode: 'ACCOUNTS', isApprovalStep: true },
          { stepKey: 'COMPLETED', label: 'Scholarship Verified & Processed', roleRequired: 'SYSTEM', isApprovalStep: false },
        ],
      },
      {
        name: 'Fee Payment & Refund Query',
        key: 'fee_request',
        description: 'Verification of fee payments, balance disputes, and refund applications.',
        category: 'FINANCE',
        responsibleDepartmentCode: 'ACCOUNTS',
        requiredFields: ['purpose'],
        steps: [
          { stepKey: 'SUBMITTED', label: 'Fee Query Submitted', roleRequired: 'STUDENT', isApprovalStep: false },
          { stepKey: 'VALIDATION', label: 'Accounts Ledger Verification', roleRequired: 'SYSTEM', isApprovalStep: false },
          { stepKey: 'FINANCE_REVIEW', label: 'Accounts Officer Review', roleRequired: 'STAFF', assignedDepartmentCode: 'ACCOUNTS', isApprovalStep: true },
          { stepKey: 'COMPLETED', label: 'Fee Query Resolved', roleRequired: 'SYSTEM', isApprovalStep: false },
        ],
      },
      {
        name: 'General Student Assistance Request',
        key: 'student_assistance',
        description: 'General support and administrative assistance for campus operations.',
        category: 'ASSISTANCE',
        responsibleDepartmentCode: 'STUDENT_SECTION',
        requiredFields: ['purpose'],
        steps: [
          { stepKey: 'SUBMITTED', label: 'Assistance Requested', roleRequired: 'STUDENT', isApprovalStep: false },
          { stepKey: 'VALIDATION', label: 'Desk Assignment', roleRequired: 'SYSTEM', isApprovalStep: false },
          { stepKey: 'OFFICER_REVIEW', label: 'Section Officer Review', roleRequired: 'STAFF', assignedDepartmentCode: 'STUDENT_SECTION', isApprovalStep: true },
          { stepKey: 'COMPLETED', label: 'Assistance Completed', roleRequired: 'SYSTEM', isApprovalStep: false },
        ],
      },
      {
        name: 'Event & Club Permission Request',
        key: 'event_permission',
        description: 'Approval workflow for organizing campus events, symposiums, and club activities.',
        category: 'EVENT',
        responsibleDepartmentCode: 'STUDENT_SECTION',
        requiredFields: ['purpose'],
        steps: [
          { stepKey: 'SUBMITTED', label: 'Proposal Submitted', roleRequired: 'STUDENT', isApprovalStep: false },
          { stepKey: 'VALIDATION', label: 'Venue & Schedule Check', roleRequired: 'SYSTEM', isApprovalStep: false },
          { stepKey: 'FACULTY_APPROVAL', label: 'Faculty Coordinator Approval', roleRequired: 'FACULTY', assignedDepartmentCode: 'CSE', isApprovalStep: true },
          { stepKey: 'COMPLETED', label: 'Event Sanctioned', roleRequired: 'SYSTEM', isApprovalStep: false },
        ],
      },
      {
        name: 'Internship Permission & Document Request',
        key: 'internship_document',
        description: 'Approval letter and NOC request for industry internships.',
        category: 'DOCUMENT',
        responsibleDepartmentCode: 'STUDENT_SECTION',
        requiredFields: ['purpose'],
        steps: [
          { stepKey: 'SUBMITTED', label: 'Internship Request Submitted', roleRequired: 'STUDENT', isApprovalStep: false },
          { stepKey: 'VALIDATION', label: 'Academic Eligibility Check', roleRequired: 'SYSTEM', isApprovalStep: false },
          { stepKey: 'HOD_APPROVAL', label: 'Department HOD Approval', roleRequired: 'HOD', assignedDepartmentCode: 'CSE', isApprovalStep: true },
          { stepKey: 'COMPLETED', label: 'NOC Issued & Completed', roleRequired: 'SYSTEM', isApprovalStep: false },
        ],
      },
      {
        name: 'Hostel Accommodation & Welfare Request',
        key: 'hostel_request',
        description: 'Hostel room allocation, room maintenance, and hostel gate pass requests.',
        category: 'HOSTEL',
        responsibleDepartmentCode: 'HOSTEL',
        requiredFields: ['purpose'],
        steps: [
          { stepKey: 'SUBMITTED', label: 'Hostel Request Submitted', roleRequired: 'STUDENT', isApprovalStep: false },
          { stepKey: 'VALIDATION', label: 'Hostel Record Verification', roleRequired: 'SYSTEM', isApprovalStep: false },
          { stepKey: 'WARDEN_REVIEW', label: 'Hostel Warden Approval', roleRequired: 'STAFF', assignedDepartmentCode: 'HOSTEL', isApprovalStep: true },
          { stepKey: 'COMPLETED', label: 'Hostel Request Processed', roleRequired: 'SYSTEM', isApprovalStep: false },
        ],
      },
      {
        name: 'Campus Transportation & Bus Pass Request',
        key: 'transportation_request',
        description: 'University bus pass issue, route modification, and transport queries.',
        category: 'TRANSPORT',
        responsibleDepartmentCode: 'STUDENT_SECTION',
        requiredFields: ['purpose'],
        steps: [
          { stepKey: 'SUBMITTED', label: 'Transport Request Submitted', roleRequired: 'STUDENT', isApprovalStep: false },
          { stepKey: 'VALIDATION', label: 'Route Verification', roleRequired: 'SYSTEM', isApprovalStep: false },
          { stepKey: 'DESK_REVIEW', label: 'Transport Officer Review', roleRequired: 'STAFF', assignedDepartmentCode: 'STUDENT_SECTION', isApprovalStep: true },
          { stepKey: 'COMPLETED', label: 'Bus Pass Issued & Processed', roleRequired: 'SYSTEM', isApprovalStep: false },
        ],
      },
    ];
